export default {
  ...
  STOCK_STATUS_FEW_LEFT: 'Få tilbage!',
  ...
  NO_PRODUCT_SPECIFICATION:
    'Desværre er der ingen produktdetaljer at vise for dette produkt.',
  ...
  NEWSLETTER_TEXT: 'Tilmeld dig nyhedsbreve.',
  NEWSLETTER_OFFER: '15% på dit første køb!',
  ...
  CHECKOUT_CONFIRM_TEXT:
    'Vi har nu modtaget din ordre, og du vil snart modtage din ordrebekræftelse til {email}. Håber du bliver glad for dit nye outfit!',
  ...
  VOYADO_SEARCH_FORM: 'Søg',
  VOYADO_SEARCH_FORM_PLACEHOLDER: 'Søg',
  VOYADO_SEARCH_RESULTS_TITLE: 'Søgeresultater',
  VOYADO_SEARCH_RESULTS_SEE_ALL: 'Se alle søgeresultater',
  VOYADO_SEARCH_RESULTS_NO_MATCH:
    'Desværre ingen resultater, der matcher din søgning',
  VOYADO_SEARCH_RESULTS_SUGGESTIONS_TITLE: 'Populære søgninger',
  VOYADO_SEARCH_RECENT_SEARCHES_TITLE: 'Seneste søgninger',
  VOYADO_SEARCH_RESULTS_REMOVE_RECENT: 'Ryd',
  VOYADO_SEARCH_PRODUCT_RESULTS_TITLE: 'Produkt | Produkter',
  VOYADO_SEARCH_RESULTS_BUTTON: 'Vis {hits} produkt | Vis {hits} produkter',
  VOYADO_SEARCH_CLOSE: 'Luk',
  VOYADO_SEARCH_PAGE_TITLE: 'Søgeresultat for: {search}',
  VOYADO_RECOMMENDATIONS_TITLE_ALTERNATIVES_1: 'Andre købte også',
  VOYADO_RECOMMENDATIONS_TITLE_ALTERNATIVES_2: 'Du kan også lide',
  VOYADO_RECOMMENDATIONS_TITLE_ALTERNATIVES_3: 'Lignende produkter',
  VOYADO_RECOMMENDATIONS_TITLE_UPSELL_1: 'Noget for dig?',
  VOYADO_RECOMMENDATIONS_TITLE_UPSELL_2: 'Finder du en favorit her?',
  VOYADO_RECOMMENDATIONS_TITLE_UPSELL_3: 'Gå ikke glip af disse',
  VOYADO_RECOMMENDATIONS_TITLE_NEWEST_PRODUCTS: 'Nye varer',
  VOYADO_RECOMMENDATIONS_TITLE_TOP_PRODUCTS: 'Topsælgere',
