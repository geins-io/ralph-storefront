export default {
  ...
  USP_1: 'Fast delivery',
  USP_2: 'Free shipping over €79',
  USP_3: '30 day right of return',
  USP_4: 'Secure payment',
  USP_TEXT: 'Fast delivery - Free shipping on purchases over €79',
  CUSTOMER_SERVICE: 'Customer service',
  CUSTOMER_SERVICE_PHONE_TITLE: 'Phone',
  ...
  NEXT: 'Next',
  PREVIOUS: 'Previous',
  READ_MORE: 'Show all categories',
  READ_LESS: 'Show less categories',
  SHOW: 'Show',
  HIDE: 'Hide',
  LOAD_MORE: 'Load more',
  ...
  SORT_LABEL_CUSTOM_1: 'Bestsellers',
  ...
  NEWSLETTER_OFFER: '15% on your first purchase!',
  ...
  SEO_READ_LESS: 'Less',
  BESTSELLER_PAGE_TITLE: 'Bestsellers',
