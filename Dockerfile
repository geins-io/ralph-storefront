...
ARG VOYADO_CLUSTER_ID=#{VoyadoClusterId}#
ARG RALPH_ENV=#{RalphEnv}#
ARG VOYADO_ENGAGE_API_KEY=#{VoyadoEngageApiKey}#
...
ARG VOYADO_CLUSTER_ID
ARG RALPH_ENV
ARG VOYADO_ENGAGE_API_KEY
...
ENV VOYADO_CLUSTER_ID=${VOYADO_CLUSTER_ID}
ENV RALPH_ENV=${RALPH_ENV}
ENV VOYADO_ENGAGE_API_KEY=${VOYADO_ENGAGE_API_KEY}
RUN npm install
